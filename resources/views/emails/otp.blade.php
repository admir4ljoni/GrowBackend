...
<body>
  ...
  <div class="container">
    <div class="header">
      <a>Prove Your GrowExpand Identity</a>
    </div>
    <br />
    <strong>Dear {{ $name }},</strong>
    <p>
      We have received a login request for your GrowExpand account. For
    ...
    <p style="font-size: 0.9em">
      ...
      <br />
      <br />
      <strong>Thank you for using GrowExpand.</strong>
      <br />
      <br />
      Best regards,
      <br />
      <strong>GrowExpand</strong>
    </p>
    ...
    <div class="footer">
      ...
      <p>
        For more information about GrowExpand and your account, visit
        <strong>GrowExpand</strong>
      </p>
    </div>
  </div>
  <div style="text-align: center">
    <div class="email-info">
      &copy; 2024 GrowExpand. All rights
      reserved.
    </div>
  </div>
</body>
